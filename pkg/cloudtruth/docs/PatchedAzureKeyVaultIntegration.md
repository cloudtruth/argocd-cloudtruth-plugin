...
**StatusLastCheckedAt** | Pointer to **NullableTime** | The last time the status was evaluated. | [optional] [readonly] 
...
`func (o *PatchedAzureKeyVaultIntegration) SetStatusLastCheckedAtNil(b bool)`
